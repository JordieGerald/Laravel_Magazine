				...
				<div class="card-body">
                    <form method="POST" action="{{ route('playlist.update', $playlist->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul_playlist" class="form-control" id="judul_playlist" value="{{ $playlist->judul_playlist }}" placeholder="Masukan Playlist">
                            <small id="judul" class="form-text text-muted">Silahkan masukan nama playlist.</small>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="gambar_playlist" class="form-control" placeholder="Masukan Gambar Playlist">
                            <br>
                            <small id="gambar_playlist" class="form-text text-muted">Silahkan masukan/ganti playlist.</small>
                            <br>
                            <img src=" {{ asset('uploads/' . $playlist->gambar_playlist) }}" alt="gambar_playlist" width="200">
                            <small id="gambar_playlist" class="form-text text-muted">Gambar saat ini.</small>
                        </div>
                        <div class="form-group">
