				...
				<div class="card-body">
                    <form method="POST" action="{{ route('playlist.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul_playlist" class="form-control" id="judul_playlist" placeholder="Masukan Playlist">
                        ...
                        <div class="form-group">
                            ...
                            <small id="gambar_playlist" class="form-text text-muted">Silahkan masukan gambar.</small>
                        </div>
                        <div class="form-group">
